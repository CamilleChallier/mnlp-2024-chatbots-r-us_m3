...
model_checkpoint = "/home/ckalberm/project-m3-2024-chatbots-r-us/models/flan-t5-large-LoRA-merged-mcqa-ai2"
#model_name = "flan-t5-large-LoRA-merged"
model_name = "flan-t5-large-LoRA-merged-mcqa-ai2"
...
training_args = Seq2SeqTrainingArguments(
    output_dir=f"{model_name}-mcqa-sciq",
    report_to="tensorboard",
    logging_dir="./tensorboard/"+model_name+"-mcqa-sciq",
...
trainer.train()
# save the model
trainer.save_model(f"models/{model_name}-mcqa-sciq")
# save the tokenizer
tokenizer.save_pretrained(f"models/{model_name}-mcqa-sciq")
